function [post, cloneId, condP, prior, pDataSum]=callSNV(T, W, f, inputParam)
...
prior=array2table([priorSomatic priorHet priorHom priorOther],'VariableNames',{'Somatic','Het','Hom','Other'});
...
post=array2table([pSomatic pGermline pHom pOther],'VariableNames',{'Somatic','Het','Hom','Other'});
